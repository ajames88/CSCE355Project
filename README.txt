...
In order to run the simulator from to command line type 'python simulator.py' followed by the name of an input file containing the DFA and another input file containing the strings to simulate.
